    ...
    <Container sx={{ mt: 4 }}>
      ...
      <Grid container spacing={4} justifyContent="center">
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <Card>
            <CardContent>
              <Typography variant="h6" gutterBottom>수료증 발급 신청 및 출력</Typography>
              <Typography variant="body2" gutterBottom>
                신청서를 작성하여 수료증을 발급받으세요.
              </Typography>
              <Box mt={2}>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <Card>
            <CardContent>
              <Typography variant="h6" gutterBottom>콘텐츠/디자인 요청</Typography>
              <Typography variant="body2" gutterBottom>
                필요한 콘텐츠와 디자인을 요청하세요.
              </Typography>
              <Box mt={2}>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <Card>
            <CardContent>
              <Typography variant="h6" gutterBottom>공간 대여 신청</Typography>
              <Typography variant="body2" gutterBottom>
                OpenUP 공간 대여 신청
              </Typography>
              <Box mt={2}>
